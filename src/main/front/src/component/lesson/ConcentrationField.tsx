...
import {Checkbox, FormControlLabel, FormGroup, Paper, styled} from "@mui/material";
...
const ConcentrationField: React.FC<ConcentrationFieldType> = ({name, getValue, answer, onChange}) => {
    ...
    return (
            <Paper
                ...
                <Grid item xs={12}>
                    <Typography sx={{p: 1, fontSize: 12}}>정신집중훈련</Typography>
                    <TextFields size='small' type='number' name={name} label='정신집중훈련' variant="outlined"
                                sx={{width: 100, marginLeft: 1, marginRight: 1, }} helperText={errorField}
                                error={errorField !== ''}
