...
class StudentServiceTest {
    ...
    void saveAndFindById() {
        ...
        StudentDTO studentDTO = new StudentDTO("student1",15,"951205","010-8888-8888",
                ...
                "남자", StudyType.A_CLASS,"부산시","금단로",
                GradeType.HIGH,3,300,5,32,1L);
        ...
        Optional<Student> student = studentRepository.findById(save.getId());
        // then
        student.ifPresentOrElse(value -> {
            assertThat(value.getId()).isEqualTo(save.getId());
